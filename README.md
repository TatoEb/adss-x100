Install and launch X100 easily with just 2 commands:
...
or use this script:  ./stop.sh  (if it's detached and not opened on screen)


To start X100 again enter:  ./X100.sh


To change X100' config file use this script:  ./cX100.sh
